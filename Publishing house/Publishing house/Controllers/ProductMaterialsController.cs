...
namespace Publishing_house.Controllers
{
    public class ProductMaterialsController : Controller
    {
        ...
        {
            ViewData["MaterialId"] = new SelectList(_context.Materials, "Id", "Color");
        ...
        public async Task<IActionResult> Create([Bind("Id,CountMaterials,MaterialId,ProductId")] ProductMaterial productMaterial)
        {
            ...
            ViewData["MaterialId"] = new SelectList(_context.Materials, "Id", "Color", productMaterial.MaterialId);
